...
function AboutPage() {
  return (
    <About>
      ...
      <Description>
        <p>
          We are your single source recycler offering solutions that are simple
          and convenient to implement.We understand the growing needs of our
          industry and the ever changing regulatory environment.Our service is
